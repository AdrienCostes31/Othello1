 ...
 * @author Adrien
 */ 
public class PlacementPion extends Container implements ActionListener{ 
    ...
    /** Zone de saisie pour l'adresse (on peut saisir plusieurs lignes */    
    public static JButton ok;
 
    /** Abscisse du coin supérieur gauche des différents composants */     
    private static final int X[] = { 0, 1, 0, 1, 0, 0, 0, 0, 0};  
    
    /** Ordonnée du coin supérieur gauche des différents composants */     
    private static final int Y[] = { 0, 0, 1, 1, 2, 3, 4, 5, 6};  
    
    /** Largeur des différents composants */ 
    private static final int LARGEUR[] = { 1, 1, 1, 1, 2, 2, 1, 1, 1}; 
    ...
    public PlacementPion() {        
        ...
        scoreJoueur1 = new JLabel("pseudo1 : " + FenJeu.laGrille.compter('x'));
        scoreJoueur2 = new JLabel("ordi    : " + FenJeu.laGrille.compter('o'));
        /* 
        ...
        JComponent composant[] = { labelAbscisse, zoneAbscisse, labelOrdonnee, zoneOrdonnee, 
        						   labelJoueur, ok, score, scoreJoueur1, scoreJoueur2}; 
